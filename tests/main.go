...
func expectedOutputs() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"formatlistInputOnly":         []string{"hello"},
		"formatlistEmptySingle":       []string{},
		"formatlistEmptyMultiple":     []string{},
		"formatlistScalars":           []string{"hello world 32 hello"},
		"formatlistLists":             []string{"hello foo 13 baz", "hello bar 46 quux"},
		"formatlistMixed":             []string{"hello foo 32 baz", "hello bar 32 quux"},
		"index":                       1,
		"join":                        "one-two-three",
		...
		"regexallNamedGroups": []interface{}{
			map[string]interface{}{"first": "1", "second": "2"},
			map[string]interface{}{"first": "3", "second": "4"},
		},
		"range":                      []float64{0, 1, 2},
