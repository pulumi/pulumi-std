...
func expectedOutputs() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"regexNamedGroups":               map[interface{}]interface{}{"first": "1", "second": "2"},
		"regexallNoGroup":                []interface{}{"athentextb", "athenmoretextb"},
		"regexallNoMatch":                nil,
		"regexallNumberedGroups":         []interface{}{[]interface{}{"1", "2"}, []interface{}{"3", "4"}},
		"regexallNamedGroups":            []interface{}{map[interface{}]interface{}{"first": "1", "second": "2"}, map[interface{}]interface{}{"first": "3", "second": "4"}},
		"range":                          []float64{0, 1, 2},
