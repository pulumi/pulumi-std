...
func (*Timeadd) Invoke(
	_ context.Context,
	input infer.FunctionRequest[TimeaddArgs],
) (infer.FunctionResponse[TimeaddResult], error) {
	...
	return infer.FunctionResponse[TimeaddResult]{
		Output: TimeaddResult{timestamp.Add(duration).Format(time.RFC3339)},
	}, nil
}
